 ...
 * @since 1.1.0
 */
class Elementor_Post_Widget extends Widget_Base {
	...
	private function mtl_get_all_post_categories( $post_type ) {
	...
	private function mtl_content_layout_options() {
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => __( 'Posts Per Page', 'mtl-core' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => '/',
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-meta span + span:before' => 'content: "{{VALUE}}"',
				],
				'condition' => [
					'meta_data!' => [],
				],
	...
	private function mtl_content_query_options() {
		...
		$this->add_control(
			...
			[
				...
				'type'        => Controls_Manager::SELECT2,
				'multiple'    => true,
				'options'     => $this->mtl_get_all_post_categories( 'post' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'post_date',
				'options' => [
					'post_date' => __( 'Date', 'mtl-core' ),
					'post_title' => __( 'Title', 'mtl-core' ),
	...
	private function mtl_style_layout_options() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-grid-container' => 'grid-column-gap: {{SIZE}}{{UNIT}}',
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-grid-container' => 'grid-row-gap: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	private function mtl_style_box_options() {
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post' => 'border-radius: {{SIZE}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .mtl_post_wrapper .mtl-post',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'separator' => '',
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .mtl_post_wrapper .mtl-post:hover',
			]
		);
	...
	private function mtl_style_title_options() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .mtl_post_wrapper .mtl-post .title, {{WRAPPER}} .mtl_post_wrapper .mtl-post .title > a',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .title, {{WRAPPER}} .mtl_post_wrapper .mtl-post .title > a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .title, {{WRAPPER}} .mtl_post_wrapper .mtl-post .title > a:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .title ' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	private function mtl_style_meta_options() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-meta span',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-meta span' => 'color: {{VALUE}};',
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-meta span a' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-meta' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	private function mtl_style_content_options() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-excerpt p',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-excerpt p' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post .post-grid-excerpt' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	private function mtl_style_readmore_options() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => __( 'Background Color', 'mtl-core' ),
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => __( 'Border Color', 'mtl-core' ),
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn:hover' => 'color: {{VALUE}};',
				),
			)
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => __( 'Background Color', 'mtl-core' ),
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label'     => __( 'Border Color', 'mtl-core' ),
				'selectors' => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn:hover' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => array( 'px' ),
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'border-style: solid; border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				],
			]
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'border-radius: {{SIZE}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px' ),
				'selectors'  => array(
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}',
				),
			)
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px' ],
				'selectors'  => [
					'{{WRAPPER}} .mtl_post_wrapper .mtl-post a.read-more-btn' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
